...
export interface AgentContext {
  /** 当前页面类型 */
  currentPage: 'timeline' | 'album' | 'editor' | 'ai-studio' | 'search' | 'persons';
  /** 当前选中的照片列表 */
...
export interface AgentActions {
  ...
  // 用户操作
  handleUserAction: (surfaceId: string, componentId: string, actionId: string, value?: unknown) => Promise<void>;
}
