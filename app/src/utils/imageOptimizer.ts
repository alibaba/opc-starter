...
import type { AIServiceType } from './imageValidator';
import { AI_SERVICE_CONSTRAINTS } from './imageValidator';
...
export class ImageOptimizer {
  ...
  private calculateOptimizedDimensions(
    ...
    const minDim = constraints.minDimension || Math.min(constraints.minWidth || 0, constraints.minHeight || 0);
    const maxDim = constraints.maxDimension || Math.max(constraints.maxWidth || 9999, constraints.maxHeight || 9999);
