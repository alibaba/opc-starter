...
test.describe('[P1] Dashboard 页面', () => {
  ...
  test('[P1] 应该显示快速入口卡片', async ({ authedPage: page }) => {
  ...
  test('[P1] 应该显示系统状态', async ({ authedPage: page }) => {
    // 系统状态在 Card 的 h2 中
  ...
  test('[P1] 应该显示已集成功能列表', async ({ authedPage: page }) => {
