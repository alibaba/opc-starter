            ...
            if (!this.explicitlyCleared) {
              ...
              for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                ;(e && !this.collapsed
                  ...
                  a.from == null && this.collapsed && !cr(this.doc, l) && e && Et(l, jr(e.display)))
              }
        ...
        ;(function (b) {
          ...
          b.defineMode('css', function (J, P) {
            ...
            function Pe(E, ee, K, ze) {
              return ((E.context = new dt(K, ee.indentation() + (ze === !1 ? 0 : F), E.context)), K)
            }
            function _e(E) {
      ...
      (function (ct, xt) {
        ;(function (b) {
          ...
          ;(b.defineMode('javascript', function (pe, _) {
            ...
            function lr(f) {
              if (Y && f == ':') return F.stream.match(/^\s*\w+\s+is\b/, !1) ? c(ve, mi, Re) : c(Re)
            }
            function mi(f, m) {
          ...
          function G(g) {
            return function (y, j) {
              for (var de; (de = y.next()); )
                ...
                else if (de == '/' && y.eat('*')) return ((j.tokenize = G(g + 1)), j.tokenize(y, j))
              return 'comment'
            }
          }
          $('text/x-scala', {
    ...
    _a ||
      ...
      (function (ct, xt) {
        ;(function (b) {
          ...
          function _(w) {
            var M = w.flags
            return M ?? (w.ignoreCase ? 'i' : '') + (w.global ? 'g' : '') + (w.multiline ? 'm' : '')
          }
          function te(w, M) {
          ...
          ;((b.commands.jumpToLine = function (oe) {
            ...
            pe(oe, _(oe), oe.phrase('Jump to line:'), Q.line + 1 + ':' + Q.ch, function (k) {
              if (k) {
                ...
                } else (I = /^\s*\:?\s*([\+\-]?\d+)\s*/.exec(k)) && oe.setCursor(te(oe, I[1]), Q.ch)
              }
            })
          }),
